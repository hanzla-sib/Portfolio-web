  ...
  const experiences = [
    {
      ...
      bullets: [
        "Acted as the lead AI engineer of the SieSight browser extension, one of Siemens' most popular, global AI tools for internal employees (> 10,000 users)",
        ...
        "Built a multi-step analysis pipeline for complex, multimodal PDF files, resulting in Siemens' most accurate PDF parsing algorithm (confirmed by IT DA)",
        "Enabled scalable processing of very long, complex documents, e.g. tenders, by utilizing batch processing, offscreen rasterization, and large-payload stashing",
        "Securely integrated existing Siemens AI platforms such as SiemensGPT, code.siemens.com open-source models, and ai-attack OpenAI models, with model-specific configuration, authentication, and request throttling",
